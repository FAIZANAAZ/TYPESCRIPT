...
// Question 1: Write a TypeScript function 
// that uses async/await to wait for 2 seconds and then returns a string "Hello World".
...
// Question 3: Write a TypeScript function that returns a Promise that 
// resolves with the value "Resolved!" after 3 seconds.
...
// Question 5: Write a TypeScript function that uses 
// async/await to wait for a Promise to resolve and then logs the result to the console.
...
// Question 9: Create a TypeScript function 
// that uses setTimeout to call a function repeatedly every 2 seconds.
...
// Question 10: Write a TypeScript function that uses async/await to wait for a Promise to resolve and then returns a
//  new Promise that resolves with the result multiplied by 2.
