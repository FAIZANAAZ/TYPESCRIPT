...
do {
    ...
    //************************************************** */
        ...
        let name_show2 = std_info_array.map((namee) => namee.name);
        ...
        let index = std_info_array.findIndex((studentt) => studentt.name === quation6.remove);
        if (index !== -1) {
    ...
    //************************************************** */
        ...
        let name_show = std_info_array.map((namee) => namee.name);
        ...
        if (quation7.select) {
            show_full_prop = std_info_array.find((prop) => prop.name === quation7.select);
