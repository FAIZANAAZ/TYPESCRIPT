...
async function gamerun() {
    ...
    let hero_power = 100;
    let hero_health = 100;
    console.log(chalk.hex("#eb7a34").bold(`😎 HERO NAME   : ${hero_name}
 ...
 ENAMY HEALTH : ${enamy_health}\n`));
    ...
    function thann() {
        ...
        console.log("\n*******************************************************************************************************\n");
        console.log(chalk.hex("#eb7a34").bold(`👿 NOW ENAMY POWER  : ${enamy_power}
   NOW ENAMY HEALTH : ${enamy_health}\n`));
        console.log("*******************************************************************************************************\n");
        console.log(chalk.hex("#eb7a34").bold(`😎 NOW HERO POWER  : ${hero_power}
