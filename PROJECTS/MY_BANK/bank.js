...
while (condition) {
    ...
    if (quation1.fname !== "" && quation1.lname !== "" &&
        ...
        class Customer {
            ...
            cnic_number;
            bankaccount_number;
            constructor(first_name, last_name, gaender, age, mobile_number, cnic_number, bankaccount_number) {
...
*********************************************************************************************\n`;
        ...
        //***************** CUSTOMER INSTANCE ************************ */
        let customer = new Customer(quation1.fname, quation1.lname, quation1.age, quation1.gender, quation1.mobile, quation1.nic, quation1.account);
