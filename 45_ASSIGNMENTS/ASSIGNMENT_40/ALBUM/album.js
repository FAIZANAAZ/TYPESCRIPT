"use strict";
//QUATION : Album: Write a function called make_album() that builds a Object describing a music album.
...
console.log(album1);
const album2 = make_album("artist 2", 'Album title 1');
console.log(album2);
const album3 = make_album("artist 3", 'Album title 1', 12);
console.log(album3);
